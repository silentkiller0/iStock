...
/**
 * \file    test/functional/IStockFunctionalTest.php
 * \ingroup istock
 ...
 * @package Testistock
 */
class IStockFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/istock/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('istock/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/istock/admin/about.php');
		$this->authenticate();
		return $this->assertContains('istock/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('istockwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
        ...
        return $this->assertContains(
			'interface_99_modIStock_IStockTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
        ...
        return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modIStock_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
