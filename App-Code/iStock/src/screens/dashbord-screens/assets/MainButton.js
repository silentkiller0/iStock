...
import {StyleSheet, View, Text, Image, TouchableHighlight, TouchableOpacity, Animated} from 'react-native';
    ...
    return (
        <View style={{position: 'relative', alignItems: 'center'}}>
            ...
            <Animated.View style={{position: 'relative', left: btn_1X, top: btn_1Y }}>
                ...
                <FontAwesome name="clipboard" color="#05375a" size={DeviceInfo.isTablet() ? 60 : 30} /> 
                </View>
            </Animated.View>
